...
songplay_table_create = "CREATE TABLE IF NOT EXISTS songplays (songplay_id serial PRIMARY KEY, start_time bigint NOT NULL, user_id varchar NOT NULL, level varchar, song_id varchar, artist_id varchar, session_id varchar, location varchar, user_agent varchar);"
##bigint to timestamp
...
##serial to varchar, varchar to timestamp
...
time_table_create = ("""CREATE TABLE IF NOT EXISTS time (start_time bigint PRIMARY KEY, hour varchar, day varchar, week varchar, month varchar, year varchar, \
    weekday varchar)
""")
...
time_table_insert = ("""INSERT INTO time (start_time, day, month, year, hour, weekday, week) VALUES (%s, %s, %s, %s, %s, %s, %s) ON CONFLICT (start_time) DO NOTHING;
""")
