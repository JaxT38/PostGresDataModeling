...
songplay_table_create = ("""CREATE TABLE IF NOT EXISTS songplays 
    (
        artist_id varchar, song_id varchar, 
        start_time timestamp NOT NULL, user_id integer NOT NULL, 
        level varchar, session_id varchar, 
...
song_table_create = ("""CREATE TABLE IF NOT EXISTS songs 
    (
        PRIMARY KEY (song_id, artist_id), song_id varchar, 
...
artist_table_create = ("""CREATE TABLE IF NOT EXISTS artists 
    (
        ...
        location varchar, latitude float, 
        longitude float
    )
    """)
...
song_select = ("""SELECT
        songs.song_id, 
        artists.artist_id FROM (songs JOIN artists ON songs.artist_id = artists.artist_id) WHERE songs.title=(%s) AND artists.name=(%s) and songs.duration=(%s) 
    """)
