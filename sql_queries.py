...
song_table_create = "CREATE TABLE IF NOT EXISTS songs (song_id serial PRIMARY KEY, title varchar, artist_id varchar, year int, duration float);"

artist_table_create = "CREATE TABLE IF NOT EXISTS artists (artist_id serial PRIMARY KEY, name varchar, location varchar, latitude float, longitude float);"

time_table_create = "CREATE TABLE IF NOT EXISTS time (start_time datetime, hour int, day int, week int, month int, year int, weekday int);"
...
time_table_insert = ("""INSERT INTO time (start_time, day, month, year, hour, weekday, week) VALUES (%s, %s, %s, %s, %s, %s, %s);
""")
